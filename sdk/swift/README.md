# FluxChat SDK — Swift (iOS / macOS)

> Community SDK — tracked in [issue #6](https://github.com/benflux-company/fluxchat-sdk/issues/6)
...
```swift
let client = FluxChat(apiKey: "fc_prod_...")

let response = try await client.ask("What are your opening hours?")
...
Use `Package.swift`. Use `URLSession` — no external dependencies. Target iOS 16+ / macOS 13+.
